...
// const String SERVER_URL = "ws://" + String(WEBSOCKET_HOST) + ":" + String(WEBSOCKET_PORT);
...
// #define CONFIG_I2S_BCK_PIN I2S_SPEAKER_BCLK
// #define CONFIG_I2S_LRCK_PIN I2S_SPEAKER_LRC  
// #define CONFIG_I2S_DATA_PIN I2S_SPEAKER_DIN
// #define CONFIG_I2S_DATA_IN_PIN I2S_SD
...
//     // Initial LED states
//     digitalWrite(LED_SPKR, HIGH);  // Turn on speaker LED initially
//     digitalWrite(LED_MIC, LOW);    // Start with mic LED off
